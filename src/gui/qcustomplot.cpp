...
/*! \class QCPAxis
  ...
  \image html AxisNamesDefault.png
  <center>Naming convention of axis parts</center>
  \n

  \image html AxisRectSpacingDefault.png
  <center>Default of the spacings and paddings that define the geometry of an axis. The dashed gray line
...
/*! \class QCPAxisRect
  ...
  \image html AxisRectSpacingDefault.png
  <center>Default of the spacings and paddings that define the geometry of an axis. The dashed
